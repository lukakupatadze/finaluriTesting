package com.example.finaluritesting.fragments
...
import com.example.finaluritesting.Menu
import com.example.finaluritesting.R
...
class FragmentAuthorization: Fragment(R.layout.activity_authorization) {
    ...
    private fun goToProfile() {
        val intent = Intent(this@FragmentAuthorization.requireContext(), Menu::class.java)
        startActivity(intent)
        activity?.finish()
    }
